...
@Autonomous(name = "Auto Shoot Sequence", group = "Group 1")
public class AutoShootSequence extends PeriodicOpMode {
  ...
  public void start() {
    ...
    Scheduler.getDefault().schedule(robot.shootSequence());
