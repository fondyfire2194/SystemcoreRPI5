//LimelightHelpers v1.14 — WPILib 2027 Port
// Changes: edu.wpi.first -> org.wpilib packages, Jackson -> Avaje Jsonb,
// Rotation2d constructor updated, TimestampedDoubleArray field access updated.
 ...
 */
public class LimelightHelpers_2027 {
    ...
    public static class LimelightTarget_Retro {
        ...
        public Pose3d asCameraPose_TargetSpace()
        {
            return toPose3D(cameraPose_TargetSpace);
        }
        public Pose3d asRobotPose_FieldSpace()
        {
            return toPose3D(robotPose_FieldSpace);
        }
        public Pose3d asRobotPose_TargetSpace()
        {
            return toPose3D(robotPose_TargetSpace);
        }
        public Pose3d asTargetPose_CameraSpace()
        {
            return toPose3D(targetPose_CameraSpace);
        }
        public Pose3d asTargetPose_RobotSpace()
        {
            return toPose3D(targetPose_RobotSpace);
        }

        public Pose2d asCameraPose_TargetSpace2D()
        {
            return toPose2D(cameraPose_TargetSpace);
        }
        public Pose2d asRobotPose_FieldSpace2D()
        {
            return toPose2D(robotPose_FieldSpace);
        }
        public Pose2d asRobotPose_TargetSpace2D()
        {
            return toPose2D(robotPose_TargetSpace);
        }
        public Pose2d asTargetPose_CameraSpace2D()
        {
            return toPose2D(targetPose_CameraSpace);
        }
        public Pose2d asTargetPose_RobotSpace2D()
        {
    ...
    public static class LimelightResults {
        ...
        // WPILib2027: Limelight sends "v" as 0/1 integer; Avaje Jsonb handles int->boolean
        // coercion automatically when the field is declared boolean. No annotation needed.
        @Json.Property("v")
        ...
        public Pose3d asBotPose3d() {
            return toPose3D(botpose);
        }
    
        public Pose3d asBotPose3d_wpiRed() {
            return toPose3D(botpose_wpired);
        }
    
        public Pose3d asBotPose3d_wpiBlue() {
            return toPose3D(botpose_wpiblue);
        }

        public Pose2d asBotPose2d() {
            return toPose2D(botpose);
        }
    
        public Pose2d asBotPose2d_wpiRed() {
            return toPose2D(botpose_wpired);
        }
    
        public Pose2d asBotPose2d_wpiBlue() {
    ...
    private static JsonType<LimelightResults> resultsType;
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName, boolean isMegaTag2) {
        DoubleArrayEntry poseEntry = LimelightHelpers_2027.getLimelightDoubleArrayEntry(limelightName, entryName);
    ...
    public static RawFiducial[] getRawFiducials(String limelightName) {
        var entry = LimelightHelpers_2027.getLimelightNTTableEntry(limelightName, "rawfiducials");
    ...
    public static RawDetection[] getRawDetections(String limelightName) {
        var entry = LimelightHelpers_2027.getLimelightNTTableEntry(limelightName, "rawdetections");
    ...
    public static RawTarget[] getRawTargets(String limelightName) {
        var entry = LimelightHelpers_2027.getLimelightNTTableEntry(limelightName, "rawtargets");
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        ...
        LimelightHelpers_2027.LimelightResults results = new LimelightHelpers_2027.LimelightResults();
        if (jsonb == null) {
            jsonb = Jsonb.builder().build();
            resultsType = jsonb.type(LimelightResults.class);
        }
        ...
        try {
            ...
            if (jsonString == null || jsonString.isEmpty() || jsonString.isBlank()) {
                ...
                results = resultsType.fromJson(jsonString);
